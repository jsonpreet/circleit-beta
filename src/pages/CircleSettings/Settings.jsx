                ...
                {isCircle ?
                  <>
                    ...
                    <button
                      ...
                      className={`${activeTab === "monetization"
                          ? "anotherBG"
                          : null
                        }  menu font-semibold anotherBGhover rounded-lg px-4 text-left transition w-full delay-75 py-2`}>
                      Monetization
    ...
    <>
      <DefaultLayout>
        <div className='flex flex-col mt-6 justify-start items-start'>
          <div className='w-full'>
            {activeTab === "account" && <Account user={user} sidebar={<Sidebar activeTab={activeTab} currentActiveTab={currentActiveTab} handleTabChange={handleTabChange} />} />}
            {activeTab === "moderation" && <Moderation user={user} sidebar={<Sidebar activeTab={activeTab} currentActiveTab={currentActiveTab} handleTabChange={handleTabChange} />} />}
            {activeTab === "verification" && <Verification user={user} sidebar={<Sidebar activeTab={activeTab} currentActiveTab={currentActiveTab} handleTabChange={handleTabChange} />} />}
            {activeTab === "monetization" && <Monetization user={user} sidebar={<Sidebar activeTab={activeTab} currentActiveTab={currentActiveTab} handleTabChange={handleTabChange} />} />}
            {activeTab === "delete" && <Delete user={user} sidebar={<Sidebar activeTab={activeTab} currentActiveTab={currentActiveTab} handleTabChange={handleTabChange} />} />}
          </div>
        </div>
      </DefaultLayout>
    </>
