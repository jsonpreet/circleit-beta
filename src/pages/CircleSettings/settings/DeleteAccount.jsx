...
export default function Delete({ user, sidebar }) {
  ...
  const updateProfile = async () => {
    ...
    try {
      ...
      if (response) {
        await supabase.from('circles').delete().eq('PublicKeyBase58Check', user.profile.PublicKeyBase58Check)
        ...
        <div className="flex flex-col w-full md:w-3/4 secondaryBg border secondaryBorder rounded-xl p-4">
          <div className='flex flex-col w-full space-y-4'>
            <div className="w-full md:w-3/5">
              ...
              <p>Note: Deleting a Cicle will remove all your circle settings.</p>
            </div>
            <div className='w-full md:w-3/5'>
