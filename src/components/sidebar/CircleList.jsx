      ...
      <div className='flex flex-col'>
        {list.length > 0 &&
          list.map((circle, index) => {
            let circleUsername = circle.Username.toLowerCase();
            return (
              <Link
                key={circleUsername}
                ...
                <img
                  src={`https://diamondapp.com/api/v0/get-single-profile-picture/${circle.PublicKeyBase58Check}?fallback=https://diamondapp.com/assets/img/default_profile_pic.png`}
